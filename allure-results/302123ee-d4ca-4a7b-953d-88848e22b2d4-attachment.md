...
Error: locator.click: Error: strict mode violation: locator('a').filter({ hasText: 'Fashion' }) resolved to 2 elements:
    1) <a tabindex="0" class="nav-a  " data-csa-c-type="link" data-csa-c-slot-id="nav_cs_7" data-csa-c-content-id="nav_cs_fashion" data-csa-c-id="v0a0gm-l1gjh5-3mcriq-d05brj" href="/gp/browse.html?node=6648217031&ref_=nav_cs_fashion">Fashion</a> aka getByRole('link', { name: 'Fashion', exact: true })
