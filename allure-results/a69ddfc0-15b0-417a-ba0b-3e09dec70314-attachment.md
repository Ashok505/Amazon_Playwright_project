...
Call log:
  - waiting for getByRole('dialog', { name: 'Client MOL Edit Upload' })
    - locator resolved to <section role="dialog" tabindex="-1" aria-modal="true" data-modal-content="true" aria-describedby="mantine-3h4z2gj7s-body" aria-labelledby="mantine-3h4z2gj7s-title" class="m_fd1ab0aa m_54c44539 mantine-Modal-content m_1b7284a3 mantine-Paper-root">…</section>
  ...
  - rowgroup:
    - row "Select all rows S.no. E-Code/RFID Employee Name Email ID Aadhar Number Type Expected DOJ Onboarding Status Offer Letter Action":
      ...
      - cell "Action":
        - paragraph: Action
  - rowgroup:
    - row "Select row 1 - Bahringer Casimer_Hamill@hotmail.com ********1100 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "1":
        - paragraph: "1"
      ...
      - cell:
        - img
    - row "Select row 2 - Hansen Bulah.Kunze83@gmail.com ********2172 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "2":
        - paragraph: "2"
      ...
      - cell:
        - img
    - row "Select row 3 - Buckridge Gussie.Trantow@yahoo.com ********2602 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "3":
        - paragraph: "3"
      ...
      - cell:
        - img
    - row "Select row 4 - Jacobson - ********5903 manual - Contact Information Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "4":
        - paragraph: "4"
      ...
      - cell:
        - img
    - row "Select row 5 - Williamson - ********4956 manual - Contact Information Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "5":
        - paragraph: "5"
      ...
      - cell:
        - img
    - row "Select row 6 - Lockman Helen_Harvey85@gmail.com ********2236 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "6":
        - paragraph: "6"
      ...
      - cell:
        - img
    - row "Select row 7 - Cummerata - ********3252 manual - Contact Information Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "7":
        - paragraph: "7"
      ...
      - cell:
        - img
    - row "Select row 8 - Hoppe Weston.Grant74@yahoo.com ********7229 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "8":
        - paragraph: "8"
      ...
      - cell "Hoppe":
        - paragraph: Hoppe
      - cell "Weston.Grant74@yahoo.com":
        - paragraph: Weston.Grant74@yahoo.com
      - cell "********7229":
        - paragraph: "********7229"
      - cell "manual":
        - paragraph: manual
      ...
      - cell:
        - img
    - row "Select row 9 7F0ZJReKu Netap netapQ@gmail.com ********9234 manual 16 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "9":
        - paragraph: "9"
      ...
      - cell:
        - img
    - row "Select row 10 - aaaaa - ********9900 manual - Contact Information Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "10":
        - paragraph: "10"
