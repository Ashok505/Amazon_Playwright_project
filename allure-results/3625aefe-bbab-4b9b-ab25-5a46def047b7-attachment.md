...
Call log:
  - waiting for locator('//button//span[text()="Select Client"]')

    at /home/ashok/Desktop/amazon-playwright-js/tests/downloadEditUpload.spec.js:17:64
```
  ...
  - rowgroup:
    - row "Select all rows S.no. E-Code/RFID Employee Name Email ID Aadhar Number Type Expected DOJ Onboarding Status Offer Letter Action":
      ...
      - cell "Action":
        - paragraph: Action
  - rowgroup:
    - row "Select row 1 - Trantow Eddie_Hamill62@hotmail.com ********4132 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "1":
        - paragraph: "1"
      ...
      - cell "Trantow":
        - paragraph: Trantow
      - cell "Eddie_Hamill62@hotmail.com":
        - paragraph: Eddie_Hamill62@hotmail.com
      - cell "********4132":
        - paragraph: "********4132"
      - cell "manual":
        - paragraph: manual
      ...
      - cell:
        - img
    - row "Select row 2 7F0ZJReKu Netap netapQ@gmail.com ********9234 manual 16 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "2":
        - paragraph: "2"
      ...
      - cell:
        - img
    - row "Select row 3 - aaaaa - ********9900 manual - Contact Information Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "3":
        - paragraph: "3"
      ...
      - cell:
        - img
    - row "Select row 4 lwXoknbV ttt ttt@test.com ********3268 manual 15 May 2025 OL Generated":
      - cell "Select row":
        - checkbox "Select row"
      - cell "4":
        - paragraph: "4"
      ...
      - cell:
        - img
    - row "Select row 5 O5QxMTNJ6 ppppp gfd@test.com ********4466 manual 23 May 2025 QC Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "5":
        - paragraph: "5"
      ...
      - cell:
        - img
    - row "Select row 6 8YO94yxy kkk kkk@test.com ********3429 manual 14 May 2025 QC Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "6":
        - paragraph: "6"
      ...
      - cell:
        - img
    - row "Select row 7 - Bode Shania_Beahan@yahoo.com ********4644 manual 10 May 2025 Aadhar Card Front, Aadhar Card Back, PAN Card Documents, Bank Documents, Educational Documents Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "7":
        - paragraph: "7"
      ...
      - cell:
        - img
    - row "Select row 8 q7KTLazX4z Jaydev jaydev@gmail.com ********9234 manual 02 May 2025 OL Generated":
      - cell "Select row":
        - checkbox "Select row"
      - cell "8":
        - paragraph: "8"
      ...
      - cell:
        - img
    - row "Select row 9 HutSq0Z5c New New13@hotmail.com ********1000 manual 30 Apr 2025 QC Pending":
      - cell "Select row":
        - checkbox "Select row"
      - cell "9":
        - paragraph: "9"
      ...
      - cell:
        - img
    - row "Select row 10 9yBZC1Lc New Name Automated netapp011@gmail.com ********9203 manual 20 Apr 2025 OL Generated":
      - cell "Select row":
        - checkbox "Select row"
      - cell "10":
        - paragraph: "10"
