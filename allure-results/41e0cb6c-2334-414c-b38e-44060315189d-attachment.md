...
Call log:
  - waiting for locator('#username')
    ...
    at /home/ashok/Desktop/amazon-playwright-js/tests/downloadEditUpload.spec.js:9:35
```
...
```ts
   ...
   8 |   await page.goto('https://hcm-auth-uat.teamlease.com:3035/realms/hiretech/protocol/openid-connect/auth?...');
